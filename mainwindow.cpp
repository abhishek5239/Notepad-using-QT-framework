...
//1..created an object of QColor and also declared an static function -> getColor which will take 3 arguent
    // it will first set the default color to white and will ask for parent and title as mention below

//settextbackgroundcolor method is called to set the color
